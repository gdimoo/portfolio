...
const orders = [
    {
        id: "#874522648",
        items: "ข้าวหอมมะลิ, น้ำส้มคั้นสด, ไข่ไก่",
        price: 403,
        date: "02/02/2025",
        status: "กำลังจัดส่ง",
    ...
    {
        id: "#874511200",
        items: "เนื้อหมูสามชั้น, มะเขือเทศราชินี",
        price: 155,
        date: "29/01/2025",
        status: "จัดส่งแล้ว",
    ...
    {
        id: "#874490033",
        items: "นมสด UHT x6, แอปเปิ้ลฟูจิ",
        price: 264,
        date: "20/01/2025",
        status: "จัดส่งแล้ว",
        statusColor: C.secondary,
...
const storeOrders = [
    {
        customer: "อัญชลี ศรีสุข",
        products: "ข้าวหอมมะลิ, น้ำส้มคั้น, ไข่ไก่",
        price: "3,638,066",
        status: "กำลังจัดส่ง",
        time: "2025-02-05 08:28",
        color: "#FF6B35",
    },
    {
        customer: "บุญคุณ อินทร์แสง",
        products: "ชาน้ำแข็ง, หน้าหมูกรอบ",
        price: "6,462,020",
        status: "ยังไม่ชำระ",
        time: "2025-02-03 19:49",
        color: "#999",
    },
    {
        customer: "ธนวัฒน์ พักพิมสมปัติ",
        products: "ยาแก้ไอ, ผ้าพันแผล, ยาราคาปานกลาง",
        price: "8,664,948",
        status: "ยกเลิกออเดอร์",
        time: "2025-02-02 19:17",
        color: "#E53935",
    },
    {
        customer: "กิติพงษ์ อรุณโยค",
        products: "ตำมันรวม, น้ำเสาวรส",
        price: "2,592,335",
        status: "กำลังจัดส่ง",
        time: "2025-02-02 09:46",
        color: "#FF6B35",
    },
];
            ...
            {tabs.map((t) => (
                ...
                >
                    <Icon
                        name={t.icon}
                        size={22}
                        color={screen === t.id ? C.primary : "#BBBBBB"}
                    />
                    <span
                        style={{
                            fontSize: 10,
                            color: screen === t.id ? C.primary : "#BBBBBB",
                            fontWeight: screen === t.id ? 600 : 400,
                        }}
                    >
                        {t.label}
                    </span>
            ...
            <div style={{ padding: "0 16px 20px" }}>
                ...
                >
                    ...
                    >
                        ลดสูงสุด
                        <br />
                        <span style={{ fontSize: 36 }}>70%</span>
                    </div>
                    ...
                    {categories.map((c) => (
                        <div
                            ...
                            style={{
                                ...
                                fontSize: 13,
                                cursor: "pointer",
                                border: `1px solid ${activeCat === c ? C.primary : C.border}`,
                                flexShrink: 0,
                                transition: "all 0.2s",
                            }}
                        >
            ...
            <div style={{ padding: "20px 20px 0", background: "white" }}>
                ...
                >
                    {[1, 2, 3, 4, 5].map((s) => (
                        <Icon
                            ...
                            name="star"
                            size={14}
                            color={s <= Math.floor(p.rating) ? "#FFAA00" : "#EEE"}
                        />
                    ))}
                ...
                >
                    ...
                    <div style={{ fontSize: 13, color: C.sub, lineHeight: 1.8 }}>
                        สินค้าคุณภาพดี คัดสรรจากแหล่งผลิตโดยตรง
                        ผ่านมาตรฐานความสะอาดและความปลอดภัย เหมาะสำหรับการบริโภคในครัวเรือน
                        ส่งตรงถึงบ้านภายใน 2 ชั่วโมง
                    </div>
                </div>
                {/* Tags */}
                <div
                ...
                >
                    {["🚚 ส่งเร็ว 2 ชม.", "✅ คุณภาพรับรอง", "🔄 คืนสินค้าได้"].map(
                        (t) => (
                            <span
                                key={t}
                                style={{
                    ...
                    >
                        ...
                        {[
                            ...
                            >
                                ...
                                <span
                                    style={{
                                        color: k === "ส่วนลด" ? C.secondary : C.text,
                                        fontWeight: k === "ค่าจัดส่ง" ? 600 : 400,
                                    }}
                                >
                                    {v}
                                </span>
                        ...
                        >
                            ...
                            <span style={{ fontWeight: 700, fontSize: 17, color: C.primary }}>
                ...
                >
                    ...
                    >
                        ...
                        <div style={{ fontSize: 12, color: C.sub, textAlign: "center" }}>
                            กรุณาสแกนรหัส QR โดยใช้แอปธนาคาร
                            <br />
                            ที่รองรับ เพื่อดำเนินการชำระต่อไป
                        </div>
                    </div>
                </div>
                ...
                >
                    ...
                    >
                        {[
                            ...
                            >
                                <span>{k}</span>
                                <span style={{ color: k === "ส่วนลด" ? C.secondary : C.text }}>
                                    {v}
                                </span>
                            </div>
                        ))}
                    ...
                    >
                        ...
                        >
                            ...
                            <span
                                style={{
                                    background:
                                        o.status === "จัดส่งแล้ว" ? "#E8F9F1" : C.primaryLight,
        ...
        >
            ...
            >
                ...
                <div style={{ textAlign: "right" }}>
                    ...
                    <div style={{ fontWeight: 700, color: C.secondary, fontSize: 14 }}>
                        🥈 Silver
                    </div>
            ...
            <div
                style={{ background: C.bg, borderRadius: 8, height: 6, marginTop: 12 }}
            >
                <div
                    style={{
                        background: `linear-gradient(90deg,${C.primary},#FF9A5C)`,
                        height: "100%",
                        borderRadius: 8,
                        width: "40%",
                    }}
        ...
        <div style={{ padding: 16 }}>
            ...
            >
                {[
                    ...
                    <div
                        key={s.label}
                        style={{ background: s.bg, borderRadius: 14, padding: 14 }}
                    >
...
const SearchScreen = ({ setScreen, setSelectedProduct }) => {
    ...
    const results =
        q.length > 0
            ? products.filter(
                (p) => p.name.includes(q) || p.brand.includes(q) || p.cat.includes(q)
            )
            : [];
    const popular = [
        "ข้าวสาร",
      ...
      `}</style>
            <div
                style={{
                    ...
                    position: "relative",
                    boxShadow:
                        "0 40px 100px rgba(0,0,0,0.35), 0 0 0 12px #1A1A1A, 0 0 0 14px #333",
                }}
            >
                {/* Notch */}
                <div
                ...
                >
                    ...
                    {screen === "cart" && (
                        <CartScreen cart={cart} setCart={setCart} setScreen={setScreen} />
                    )}
                    {screen === "checkout" && (
                        <CheckoutScreen
                            cart={cart}
